...
dm = SquadDataModule(batch_size=1, dataset_config_name="plain_text", max_length=384, version_2_with_negative=False, null_score_diff_threshold=0.0, doc_stride=128, n_best_size=20, max_answer_length=30, train_file="/home/noah/src/infinitesimalPhysicist/finite-answers.json", validation_file="/home/noah/src/infinitesimalPhysicist/finite-answers.json",  tokenizer=tokenizer)
